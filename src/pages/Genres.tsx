  ...
  const genres = [
    {
      ...
      count: 1247,
      color: 'bg-red-500',
      description: 'High-intensity battles and adventures',
    },
    {
      name: 'Adventure',
      count: 892,
    ...
    },
    {
      ...
      count: 634,
      color: 'bg-purple-500',
      description: 'Magic, demons, and otherworldly elements',
    },
    {
      name: 'Comedy',
      count: 523,
    ...
    },
    {
      ...
      count: 287,
      color: 'bg-orange-500',
      description: 'Everyday life and realistic situations',
    },
    {
      name: 'Thriller',
      count: 234,
      color: 'bg-indigo-500',
      description: 'Suspense and psychological tension',
    },
    {
      name: 'Horror',
      count: 156,
      color: 'bg-red-800',
      description: 'Fear, terror, and dark themes',
    },
    {
      name: 'Sci-Fi',
      count: 123,
      color: 'bg-cyan-500',
      description: 'Future technology and space adventures',
    },
    {
      name: 'Historical',
      count: 98,
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8">
          ...
          {genres.map((genre) => (
            ...
            >
              ...
              <CardContent>
                ...
                <Badge variant="secondary">{genre.count} manga</Badge>
              </CardContent>
            </Card>
          ))}
        </div>
        ...
        <div className="mt-12">
          <h2 className="text-2xl font-bold text-foreground mb-6">tendance par Genre</h2>
