    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-manga-card rounded-lg p-4 border border-border">
            <div className="text-2xl font-bold text-yellow-400">{getStatusCount("Plan to Read")}</div>
          ...
          <div className="text-center py-16">
            ...
            <p className="text-muted-foreground mb-6">
              {searchQuery || filterStatus !== "all" 
                ...
                : "Start adding manga to your watchlist to keep track of your reading progress"
              }
            </p>
            {!searchQuery && filterStatus === "all" && (
